...
Dict_General = {
    ...
    "path_img_out": "/Users/ivanmera/Documents/Industry_Lab/Template_relazione/Immagini" # To be changed
    }
Dict_EDA_Prepro = {
    ...
    "var_dist":['media_coppia_zero', 'media_pressione_velocita_1', 'media_portata_velocita_1',
                'media_pressione_velocita_a_regime', 'media_portata_velocita_a_regime','media_coppia_finale',
                'velicita_1', 'velocita_a_regime', 'Temperatura', 'n_esito'],
    "filter_n_esito": "100",
